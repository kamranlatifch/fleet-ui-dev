...
// import TravelImage from '../assets/images/TravelImage1.png';
...
//         <p className='sub__title'>Find trips that fit a flexible lifestyle</p>
//       </div>
...
//         <img src={TravelImage} className='rounded-[32px] w-full z-0' alt='' />
...
//           </div>
//         </div>
//         <div className='absolute bottom-6 right-6 left-6 flex bg-hero-gradiant shadow-primaryShadow rounded-[80px] px-8 py-4 gap-4'>
//           {/* backdrop-blur-32 */}
...
import { ArrowBack, ArrowNextSvg, Star } from '@assets/svgs';
import Avatar1 from '../assets/images/TravelAvatar1.png';
import Avatar2 from '../assets/images/userAvatar.png'; // Add more avatars as needed
import Avatar3 from '../assets/images/Avatar2.jpeg';
import Image1 from '../assets/images/TravelImage1.png';
import Image2 from '../assets/images/ValuesImage1.png'; // Add more images as needed
      ...
      <div className='flex flex-col md:flex-row gap-16 lg:gap-[128px] xl:gap-[274px] lg:max-w-[864px] xl:max-w-[1120px]'>
        ...
        <div className='relative '>
          <img
            ...
            className='rounded-[32px] w-full max-h-[610px]  md:h-[700px] md:min-w-[320px] lg:min-w-[454px] lg:min-h-[700px] xl:max-w-[454px] xl:min-h-[700px]  z-0 '
